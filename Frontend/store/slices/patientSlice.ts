  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await fetch(
        ...
        {
          headers: {
            Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..tH7vufouHJ-BwozxZQutQ-eIO8YkA-uCj7kwMWZBk24`,
          },
        }
      );
